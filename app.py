...
if not st.session_state.edit_mode:
    # Key statica per stabilità totale
...
# Inizializziamo coordinate di default
c_lat, c_lon = 37.9747, 13.5753

# Verifichiamo che il DataFrame esista e contenga le colonne prima di pulirlo
...
# --- IL TUO SATELLITE GOOGLE (FISSO E BLOCCATO) ---
folium.TileLayer(
...
# Marker animali (solo se i dati sono carichi)
...
with col_map:
    ...
    # Cattura delle coordinate (Lon/Lat -> Lat/Lon)
